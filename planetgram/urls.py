...
from planetpost.views import comment_total_vote, planet_post_detail, post_form_view, add_comment, post_list, upvote_view, downvote_view ,total_vote, comment_upvote_view, comment_downvote_view
